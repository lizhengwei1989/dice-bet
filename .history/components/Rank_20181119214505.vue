         ...
         <el-row class="dice_progress">
          ...
          <el-col :span="18">
              <div class="dice_progress_bar">
                  <span class="dice_progress_bar_active" :style="'width:'+Math.ceil((minStage.left/minStage.diceCount)*100)/100+'%'">{{$t('select.number')}} {{minStage.stage}}/7 {{$t('select.stage')}}</span>
              </div>
          </el-col>   
        </el-row>     
